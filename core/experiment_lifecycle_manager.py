...
async def example_usage():
    """Example usage of the Experiment Lifecycle Manager"""
    
    # Initialize the lifecycle manager
    manager = ExperimentLifecycleManager()
    await manager.start()
    
    try:
        # Create an experiment pipeline
        experiment_config = {
            "name": "Model Performance Enhancement",
            "description": "Testing new gradient boosting parameters",
            "owner": "data-science-team",
            "team": "ml-platform",
            "project": "model-optimization",
            "business_impact": "high",
            "priority": 3,
            "compute_requirement": 15.0,
            "auto_start": True,
            "success_criteria": {
        ...
        # Get final status
        final_status = manager.get_experiment_status(experiment_id)
